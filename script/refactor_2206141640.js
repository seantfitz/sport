...
const constructNav = ()=>{
	...
	if(navList['football'].length > 1){
		...
		for(let i of navList['football']){
			nav_football += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_football += '</select></div>';
	}else if(navList['football'].length == 1){
		nav_football = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['golf'].length > 1){
		...
		for(let i of navList['golf']){
			nav_golf += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_golf += '</select></div>';
	}else if(navList['golf'].length == 1){
		nav_golf = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['tennis'].length > 1){
		...
		for(let i of navList['tennis']){
			nav_tennis += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_tennis += '</select></div>';
	}else if(navList['tennis'].length == 1){
		nav_tennis = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['basketball'].length > 1){
		...
		for(let i of navList['basketball']){
			nav_basketball += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_basketball += '</select></div>';
	}else if(navList['basketball'].length == 1){
		nav_basketball = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['motorsport'].length > 1){
		...
		for(let i of navList['motorsport']){
			nav_motorsport += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_motorsport += '</select></div>';
	}else if(navList['motorsport'].length == 1){
		nav_motorsport = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['cricket'].length > 1){
		...
		for(let i of navList['cricket']){
			nav_cricket += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_cricket += '</select></div>';
	}else if(navList['cricket'].length == 1){
		nav_cricket = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['rugby'].length > 1){
		...
		for(let i of navList['rugby']){
			nav_rugby += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_rugby += '</select></div>';
	}else if(navList['rugby'].length == 1){
		nav_rugby = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['rugbyleague'].length > 1){
		...
		for(let i of navList['rugbyleague']){
			nav_rugbyleague += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_rugbyleague += '</select></div>';
	}else if(navList['rugbyleague'].length == 1){
		nav_rugbyleague = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}
	...
	if(navList['afl'].length > 1){
		...
		for(let i of navList['afl']){
			nav_afl += `<option value="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</option>`;
		}
		nav_afl += '</select></div>';
	}else if(navList['afl'].length == 1){
		nav_afl = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`
	}

	if(navList['ussports'].length > 0){
		for(let i of navList['ussports']){
			if(i[1] == 'nfl'){nav_nfl = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`}
			if(i[1] == 'nba'){nav_nba = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`}
			if(i[1] == 'mlb'){nav_mlb = `<div class="dropdown"><button class="sport_button" name="${i[0]}|${i[1]}|${2}|${i[3]}|${i[4]}|${[5]}|${i[6]}|${i[8]}">${i[7]}</button></div>`}
		}
	}
